...
RTS_ENTRY(stg_PTREC_WITHK_MUT);
RTS_ENTRY(stg_PTREC_WITHOUTK_MUT);
...
RTS_ENTRY(stg_TL2_TVAR_CLEAN);
RTS_ENTRY(stg_TL2_TVAR_DIRTY);
RTS_ENTRY(stg_PTREC_CHUNK);
RTS_ENTRY(stg_NOREC_CHUNK);
RTS_ENTRY(stg_CHUNKED_PTREC_HEADER);
